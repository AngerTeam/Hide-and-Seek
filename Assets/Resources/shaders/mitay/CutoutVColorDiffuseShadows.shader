Shader "mitay-walle/Cutout Vertex Color Diffuse Shadows" {
Properties {
...
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  lowp vec4 c_6;
					  highp vec2 spriteUV_7;
					  highp float tmpvar_8;
					  tmpvar_8 = fract((_Time.y * _Speed));
					  highp float tmpvar_9;
					  tmpvar_9 = float(_XFrames);
					  highp float tmpvar_10;
					  tmpvar_10 = float(_YFrames);
					  spriteUV_7.x = ((xlv_TEXCOORD0.x + floor(
					    ((tmpvar_8 * tmpvar_9) * tmpvar_10)
					  )) * (1.0/(tmpvar_9)));
					  spriteUV_7.y = ((xlv_TEXCOORD0.y - floor(
					    (tmpvar_8 * tmpvar_9)
					  )) * (1.0/(tmpvar_10)));
					  lowp vec4 tmpvar_11;
					  tmpvar_11 = texture2D (_MainTex, spriteUV_7);
					  highp vec4 tmpvar_12;
					  tmpvar_12 = ((tmpvar_11 * xlv_COLOR0) * _Color);
					  c_6 = tmpvar_12;
					  lowp float x_13;
					  x_13 = (c_6.w - _Cutoff);
					  if ((x_13 < 0.0)) {
					  ...
					  diff_16 = tmpvar_17;
					  c_15.xyz = ((c_6.xyz * tmpvar_1) * diff_16);
					  c_15.w = c_6.w;
					  c_14.w = c_15.w;
					  c_14.xyz = (c_15.xyz + (c_6.xyz * xlv_TEXCOORD3));
					  gl_FragData[0] = c_14;
					}
...
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat5.xy = vec2(ivec2(_XFrames, _YFrames));
					    u_xlat0.x = u_xlat5.x * u_xlat0.x;
					    u_xlat0.w = u_xlat5.y * u_xlat0.x;
					    ...
					    u_xlat1.xy = u_xlat5.xy * u_xlat0.wx;
					    u_xlat10_0 = texture(_MainTex, u_xlat1.xy);
					    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
					    u_xlat10_2 = u_xlat16_0.w * _Color.w + (-_Cutoff);
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  lowp vec4 c_7;
					  highp vec2 spriteUV_8;
					  highp float tmpvar_9;
					  tmpvar_9 = fract((_Time.y * _Speed));
					  highp float tmpvar_10;
					  tmpvar_10 = float(_XFrames);
					  highp float tmpvar_11;
					  tmpvar_11 = float(_YFrames);
					  spriteUV_8.x = ((xlv_TEXCOORD0.x + floor(
					    ((tmpvar_9 * tmpvar_10) * tmpvar_11)
					  )) * (1.0/(tmpvar_10)));
					  spriteUV_8.y = ((xlv_TEXCOORD0.y - floor(
					    (tmpvar_9 * tmpvar_10)
					  )) * (1.0/(tmpvar_11)));
					  lowp vec4 tmpvar_12;
					  tmpvar_12 = texture2D (_MainTex, spriteUV_8);
					  highp vec4 tmpvar_13;
					  tmpvar_13 = ((tmpvar_12 * xlv_COLOR0) * _Color);
					  c_7 = tmpvar_13;
					  lowp float x_14;
					  x_14 = (c_7.w - _Cutoff);
					  if ((x_14 < 0.0)) {
					  ...
					  diff_22 = tmpvar_23;
					  c_21.xyz = ((c_7.xyz * tmpvar_19) * diff_22);
					  c_21.w = c_7.w;
					  c_20.w = c_21.w;
					  c_20.xyz = (c_21.xyz + (c_7.xyz * xlv_TEXCOORD3));
					  gl_FragData[0] = c_20;
					}
...
Keywords { "POINT" }
					...
					void main ()
					{
					  ...
					  diff_20 = tmpvar_21;
					  c_19.xyz = ((c_6.xyz * tmpvar_1) * diff_20);
					  c_19.w = c_6.w;
					  c_18.w = c_19.w;
					  c_18.xyz = c_19.xyz;
					  gl_FragData[0] = c_18;
...
Keywords { "POINT" }
					...
					void main()
					{
					    u_xlat0.x = _Time.y * _Speed;
					    u_xlat0.x = fract(u_xlat0.x);
					    u_xlat4.xy = vec2(ivec2(_XFrames, _YFrames));
					    u_xlat0.x = u_xlat4.x * u_xlat0.x;
					    u_xlat0.w = u_xlat4.y * u_xlat0.x;
					    u_xlat0.xw = floor(u_xlat0.xw);
					    u_xlat0.x = (-u_xlat0.x) + vs_TEXCOORD0.y;
					    u_xlat4.xy = vec2(1.0, 1.0) / u_xlat4.xy;
					    u_xlat0.w = u_xlat0.w + vs_TEXCOORD0.x;
					    u_xlat1.xy = u_xlat4.xy * u_xlat0.wx;
					    u_xlat10_0 = texture(_MainTex, u_xlat1.xy);
					    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
					    u_xlat10_2 = u_xlat16_0.w * _Color.w + (-_Cutoff);
					    u_xlat0 = u_xlat16_0 * _Color;
...
Keywords { "SPOT" }
					...
					void main ()
					{
					  ...
					  diff_24 = tmpvar_25;
					  c_23.xyz = ((c_7.xyz * tmpvar_1) * diff_24);
					  c_23.w = c_7.w;
					  c_22.w = c_23.w;
					  c_22.xyz = c_23.xyz;
					  gl_FragData[0] = c_22;
...
Keywords { "SPOT" }
					...
					void main()
					{
					    ...
					    u_xlat10_16 = texture(_LightTexture0, u_xlat3.xy).w;
					#ifdef UNITY_ADRENO_ES3
					    ...
					    u_xlat10_2 = (u_xlatb3) ? 1.0 : 0.0;
					    u_xlat10_2 = u_xlat10_16 * u_xlat10_2;
...
Keywords { "POINT_COOKIE" }
					...
					void main()
					{
					    ...
					    u_xlat10_5 = texture(_LightTextureB0, vec2(u_xlat13)).w;
...
Keywords { "DIRECTIONAL_COOKIE" }
					...
					void main ()
					{
					  ...
					  diff_19 = tmpvar_20;
					  c_18.xyz = ((c_6.xyz * tmpvar_1) * diff_19);
					  c_18.w = c_6.w;
					  c_17.w = c_18.w;
					  c_17.xyz = c_18.xyz;
					  gl_FragData[0] = c_17;
...
SubProgram "gles hw_tier01 " {
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_8;
					  tmpvar_8 = texture2D (_MainTex, spriteUV_4);
					  highp vec4 tmpvar_9;
					  tmpvar_9 = ((tmpvar_8 * xlv_COLOR0) * _Color);
					  c_3 = tmpvar_9;
					  lowp float x_10;
					  x_10 = (c_3.w - _Cutoff);
					  if ((x_10 < 0.0)) {
...
SubProgram "gles3 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat10_2 = u_xlat16_0 * _Color.w + (-_Cutoff);
					#ifdef UNITY_ADRENO_ES3
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  lowp vec4 c_4;
					  highp vec2 spriteUV_5;
					  highp float tmpvar_6;
					  tmpvar_6 = fract((_Time.y * _Speed));
					  highp float tmpvar_7;
					  tmpvar_7 = float(_XFrames);
					  highp float tmpvar_8;
					  tmpvar_8 = float(_YFrames);
					  spriteUV_5.x = ((xlv_TEXCOORD0.x + floor(
					    ((tmpvar_6 * tmpvar_7) * tmpvar_8)
					  )) * (1.0/(tmpvar_7)));
					  spriteUV_5.y = ((xlv_TEXCOORD0.y - floor(
					    (tmpvar_6 * tmpvar_7)
					  )) * (1.0/(tmpvar_8)));
					  lowp vec4 tmpvar_9;
					  tmpvar_9 = texture2D (_MainTex, spriteUV_5);
					  highp vec4 tmpvar_10;
					  tmpvar_10 = ((tmpvar_9 * xlv_COLOR0) * _Color);
					  c_4 = tmpvar_10;
					  lowp float x_11;
					  x_11 = (c_4.w - _Cutoff);
					  if ((x_11 < 0.0)) {
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = (-u_xlat16_3.xyz) + vs_TEXCOORD4.xyz;
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  light_3.xyz = (tmpvar_13.xyz + xlv_TEXCOORD4);
					  lowp vec4 c_14;
					  c_14.xyz = (c_4.xyz * light_3.xyz);
					  c_14.w = c_4.w;
					  c_2 = c_14;
					  tmpvar_1 = c_2;
					  gl_FragData[0] = tmpvar_1;
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  emission_13.xyz = (emission_13.xyz + (c_3.xyz * xlv_TEXCOORD4));
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat10_0 = texture(_MainTex, u_xlat1.xy);
					    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
					    u_xlat10_2.x = u_xlat16_0.w * _Color.w + (-_Cutoff);
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_7;
					  tmpvar_7 = texture2D (_MainTex, spriteUV_3);
					  highp vec4 tmpvar_8;
					  tmpvar_8 = ((tmpvar_7 * xlv_COLOR0) * _Color);
					  c_2 = tmpvar_8;
					  lowp float x_9;
					  x_9 = (c_2.w - _Cutoff);
					  if ((x_9 < 0.0)) {
					  ...
					  emission_12.xyz = (emission_12.xyz + (c_2.xyz * xlv_TEXCOORD4));
					  gl_FragData[0] = outDiffuseOcclusion_10;
					  gl_FragData[1] = vec4(0.0, 0.0, 0.0, 0.0);
...
Keywords { "SHADOWS_DEPTH" }
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_6;
					  tmpvar_6 = texture2D (_MainTex, spriteUV_2);
					  highp vec4 tmpvar_7;
					  tmpvar_7 = ((tmpvar_6 * xlv_COLOR0) * _Color);
					  c_1 = tmpvar_7;
					  lowp float x_8;
					  x_8 = (c_1.w - _Cutoff);
					  if ((x_8 < 0.0)) {
...
Keywords { "SHADOWS_CUBE" }
					...
					void main ()
					{
					  ...
					  highp float tmpvar_6;
					  tmpvar_6 = float(_YFrames);
					  spriteUV_3.x = ((xlv_TEXCOORD1.x + floor(
					    ((tmpvar_4 * tmpvar_5) * tmpvar_6)
					  )) * (1.0/(tmpvar_5)));
					  spriteUV_3.y = ((xlv_TEXCOORD1.y - floor(
					    (tmpvar_4 * tmpvar_5)
					  )) * (1.0/(tmpvar_6)));
					  lowp vec4 tmpvar_7;
					  tmpvar_7 = texture2D (_MainTex, spriteUV_3);
