Shader "mitay-walle/Cutout Vertex Color Diffuse" {
Properties {
...
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  highp vec2 spriteUV_6;
					  highp float tmpvar_7;
					  tmpvar_7 = fract((_Time.y * _Speed));
					  highp float tmpvar_8;
					  tmpvar_8 = float(_XFrames);
					  highp float tmpvar_9;
					  tmpvar_9 = float(_YFrames);
					  spriteUV_6.x = ((xlv_TEXCOORD0.x + floor(
					    ((tmpvar_7 * tmpvar_8) * tmpvar_9)
					  )) * (1.0/(tmpvar_8)));
					  spriteUV_6.y = ((xlv_TEXCOORD0.y - floor(
					    (tmpvar_7 * tmpvar_8)
					  )) * (1.0/(tmpvar_9)));
					  lowp vec4 tmpvar_10;
					  tmpvar_10 = (texture2D (_MainTex, spriteUV_6) * xlv_COLOR0);
					  lowp float x_11;
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_11;
					  tmpvar_11 = (texture2D (_MainTex, spriteUV_7) * xlv_COLOR0);
					  lowp float x_12;
					  ...
					  diff_20 = tmpvar_21;
					  c_19.xyz = ((tmpvar_11.xyz * tmpvar_17) * diff_20);
					  c_19.w = tmpvar_11.w;
					  c_18.w = c_19.w;
					  c_18.xyz = (c_19.xyz + (tmpvar_11.xyz * xlv_TEXCOORD3));
					  gl_FragData[0] = c_18;
					}
...
Keywords { "POINT" }
					...
					void main ()
					{
					  ...
					  diff_18 = tmpvar_19;
					  c_17.xyz = ((tmpvar_10.xyz * tmpvar_1) * diff_18);
					  c_17.w = tmpvar_10.w;
					  c_16.w = c_17.w;
					  c_16.xyz = c_17.xyz;
					  gl_FragData[0] = c_16;
...
Keywords { "SPOT" }
					...
					void main ()
					{
					  ...
					  diff_22 = tmpvar_23;
					  c_21.xyz = ((tmpvar_11.xyz * tmpvar_1) * diff_22);
					  c_21.w = tmpvar_11.w;
					  c_20.w = c_21.w;
					  c_20.xyz = c_21.xyz;
					  gl_FragData[0] = c_20;
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  lowp vec4 c_11;
					  c_11.xyz = (tmpvar_8.xyz * light_3.xyz);
					  c_11.w = tmpvar_8.w;
					  c_2 = c_11;
					  tmpvar_1 = c_2;
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  lowp vec4 c_12;
					  c_12.xyz = (tmpvar_8.xyz * light_3.xyz);
					  c_12.w = tmpvar_8.w;
					  c_2 = c_12;
					  tmpvar_1 = c_2;
					  gl_FragData[0] = tmpvar_1;
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  emission_11.xyz = (emission_11.xyz + (tmpvar_7.xyz * xlv_TEXCOORD4));
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  emission_10.xyz = (emission_10.xyz + (tmpvar_6.xyz * xlv_TEXCOORD4));
