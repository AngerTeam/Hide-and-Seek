Shader "kaleb/Cutout Vertex Color Decal" {
Properties {
...
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  diff_13 = tmpvar_14;
					  c_12.xyz = ((tmpvar_6 * tmpvar_1) * diff_13);
					  c_12.w = c_7.w;
					  c_11.w = c_12.w;
					  c_11.xyz = (c_12.xyz + (tmpvar_6 * xlv_TEXCOORD3));
					  gl_FragData[0] = c_11;
					}
...
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat10_1 = u_xlat16_0.w * _Color.w + (-_Cutoff);
					    ...
					    u_xlat16_3.xyz = u_xlat16_8.xyz * u_xlat16_3.xxx + u_xlat16_4.xyz;
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  tmpvar_20 = max (0.0, dot (tmpvar_4, tmpvar_3));
					  diff_19 = tmpvar_20;
					  c_18.xyz = ((tmpvar_7 * tmpvar_16) * diff_19);
					  c_18.w = c_8.w;
					  c_17.w = c_18.w;
					  c_17.xyz = (c_18.xyz + (tmpvar_7 * xlv_TEXCOORD3));
					  gl_FragData[0] = c_17;
					}
...
Keywords { "DIRECTIONAL" "SHADOWS_SCREEN" "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat16_3.x = u_xlat10_2 * u_xlat16_3.x + _LightShadowData.x;
...
Keywords { "SPOT" }
					...
					void main()
					{
					    ...
					    u_xlat10_3 = (u_xlatb7) ? 1.0 : 0.0;
					    u_xlat10_3 = u_xlat10_2 * u_xlat10_3;
...
Keywords { "POINT_COOKIE" }
					...
					void main()
					{
					    ...
					    u_xlat16_3.xyz = vec3(u_xlat16_2) * _LightColor0.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * vec3(_Power);
					    SV_Target0.w = u_xlat0.w;
					    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat0.xyz;
					    u_xlat0.xyz = (-vs_TEXCOORD2.xyz) + _WorldSpaceLightPos0.xyz;
...
Keywords { "DIRECTIONAL_COOKIE" }
					...
					#endif
					    if((int(u_xlatb2) * int(0xffffffffu))!=0){discard;}
					    u_xlat2.xy = vs_TEXCOORD2.yy * hlslcc_mtx4unity_WorldToLight[1].xy;
					    u_xlat2.xy = hlslcc_mtx4unity_WorldToLight[0].xy * vs_TEXCOORD2.xx + u_xlat2.xy;
					    u_xlat2.xy = hlslcc_mtx4unity_WorldToLight[2].xy * vs_TEXCOORD2.zz + u_xlat2.xy;
					    u_xlat2.xy = u_xlat2.xy + hlslcc_mtx4unity_WorldToLight[3].xy;
					    u_xlat10_2 = texture(_LightTexture0, u_xlat2.xy).w;
					    u_xlat16_3.xyz = vec3(u_xlat10_2) * _LightColor0.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * vec3(_Power);
					    SV_Target0.w = u_xlat0.w;
...
SubProgram "gles hw_tier01 " {
					...
					void main ()
					{
					  ...
					  highp vec4 tmpvar_5;
					  tmpvar_5 = ((tmpvar_4 * xlv_COLOR0) * _Color);
					  c_3 = tmpvar_5;
					  lowp float x_6;
					  x_6 = (c_3.w - _Cutoff);
					  if ((x_6 < 0.0)) {
...
SubProgram "gles3 hw_tier01 " {
					...
					void main()
					{
					    ...
					    u_xlat10_1 = u_xlat16_0 * _Color.w + (-_Cutoff);
					#ifdef UNITY_ADRENO_ES3
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    ...
					    u_xlat2.xyz = (-u_xlat16_3.xyz) + vs_TEXCOORD4.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * vec3(_Power);
					    SV_Target0.w = u_xlat0.w;
					    u_xlat16_3.xyz = u_xlat2.xyz * u_xlat0.xyz;
					    SV_Target0.xyz = u_xlat16_3.xyz;
					    return;
					}
					#endif
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main ()
					{
					  ...
					  highp vec4 tmpvar_6;
					  tmpvar_6 = ((tmpvar_5 * xlv_COLOR0) * _Color);
					  c_4 = tmpvar_6;
					  tmpvar_3 = (c_4.xyz * _Power);
					  lowp float x_7;
					  x_7 = (c_4.w - _Cutoff);
					  if ((x_7 < 0.0)) {
					    discard;
					  ...
					  emission_10.xyz = (emission_10.xyz + (tmpvar_3 * xlv_TEXCOORD4));
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" }
					...
					void main()
					{
					    u_xlat10_0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
					    u_xlat10_1.x = u_xlat16_0.w * _Color.w + (-_Cutoff);
					    u_xlat0.xyz = u_xlat16_0.xyz * _Color.xyz;
					    u_xlat0.xyz = u_xlat0.xyz * vec3(_Power);
					#ifdef UNITY_ADRENO_ES3
					    u_xlatb9 = !!(u_xlat10_1.x<0.0);
					#else
					    u_xlatb9 = u_xlat10_1.x<0.0;
					#endif
...
Keywords { "LIGHTMAP_OFF" "DYNAMICLIGHTMAP_OFF" "UNITY_HDR_ON" }
					...
					void main ()
					{
					  ...
					  lowp vec4 tmpvar_11;
					  tmpvar_11.w = 1.0;
					  tmpvar_11.xyz = ((tmpvar_1 * 0.5) + 0.5);
					  outNormal_8 = tmpvar_11;
					  lowp vec4 tmpvar_12;
					  tmpvar_12.w = 1.0;
					  tmpvar_12.xyz = vec3(0.0, 0.0, 0.0);
					  emission_9 = tmpvar_12;
					  emission_9.xyz = (emission_9.xyz + (tmpvar_2 * xlv_TEXCOORD4));
...
Keywords { "SHADOWS_DEPTH" }
					...
					void main ()
					{
					  ...
					  highp vec4 tmpvar_3;
					  tmpvar_3 = ((tmpvar_2 * xlv_COLOR0) * _Color);
					  c_1 = tmpvar_3;
					  lowp float x_4;
					  x_4 = (c_1.w - _Cutoff);
					  if ((x_4 < 0.0)) {
...
Keywords { "SHADOWS_CUBE" }
					...
					void main ()
					{
					  ...
					  highp vec4 tmpvar_4;
					  tmpvar_4 = ((tmpvar_3 * xlv_COLOR0) * _Color);
					  c_2 = tmpvar_4;
					  lowp float x_5;
					  x_5 = (c_2.w - _Cutoff);
					  if ((x_5 < 0.0)) {
