...
{
	public class FriendRequestDeleteLuaCommand : RemoteLuaCommand
	{
		private string reqPersId;

		public FriendRequestDeleteLuaCommand(string reqPersId)
		{
			this.reqPersId = reqPersId;
			cmd = "friend_request_delete";
		}
		...
		{
			return string.Format("FriendRequestDeleteLuaCommand: reqPersId: {0};", reqPersId);
		}
	}
}
