...
{
	public class FriendRequestSendLuaCommand : RemoteLuaCommand
	{
		private int reqUserId;

		private string reqPersId;

		public FriendRequestSendLuaCommand(int reqUserId, string reqPersId)
		{
			this.reqUserId = reqUserId;
			this.reqPersId = reqPersId;
			cmd = "friend_request_send";
		}
		...
		{
			return string.Format("FriendRequestSendLuaCommand: reqUserId: {0}; reqPersId: {1};", reqUserId, reqPersId);
		}
	}
}
