...
{
	public class GameCenterBindForceLuaCommand : RemoteLuaCommand
	{
		private string gameCenterId;

		private string passwd;

		public GameCenterBindForceLuaCommand(string gameCenterId, string passwd)
		{
			this.gameCenterId = gameCenterId;
			this.passwd = passwd;
			cmd = "game_center_bind_force";
		}
		...
		{
			return string.Format("GameCenterBindForceLuaCommand: gameCenterId: {0}; passwd: {1};", gameCenterId, "***");
		}
	}
}
