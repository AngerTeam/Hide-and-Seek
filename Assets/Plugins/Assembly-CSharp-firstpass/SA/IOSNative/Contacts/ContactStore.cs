...
namespace SA.IOSNative.Contacts
{
	public class ContactStore : Singleton<ContactStore>
	{
		...
		{
			this.ContactsPickResult = (Action<ContactsResult>)Delegate.Combine(this.ContactsPickResult, callback);
		}

		public void RetrievePhoneContacts(Action<ContactsResult> callback)
		{
			this.ContactsLoadResult = (Action<ContactsResult>)Delegate.Combine(this.ContactsLoadResult, callback);
		}
